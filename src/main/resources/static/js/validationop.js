...
function updateValidation(processDefinitionId, measureName, measureId, validationId) {
	...
	$.ajax({
		'url' : get3242Path() + get3242basePath() +"/validation/validationOp?id=" + validationId,
		'type' : 'PUT',
...
function getMeasuresRef(processDefinitionId) {
	...
	$.ajax({
		url : get3242Path() + get3242basePath() + "/validation/measureTasks",
		type : 'get',
		contentType : "application/json; charset=utf-8",
		dataType : "json",
		data : data,
...
function createValidation(processDefinitionId, measureName, measureId) {
	...
	$.ajax({
		'url' : get3242Path() + get3242basePath() + "/validation/validationOp",
		'type' : 'POST',
		'contentType' : 'application/json; charset=utf-8',
		'dataType' : 'json',
		'data' : JSON.stringify(validationOp),
